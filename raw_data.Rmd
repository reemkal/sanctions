...
#sanctions_health_imports %>%
ggplot(gapminder, mapping = aes(x = "Imports", y = "Infant Mortality Rate", color = "country")) +
...
democracy <- read_csv("democracy/democracy.csv") %>%
  #select("Country Name", "Indicator", "1980", "2015") %>%
  filter(Indicator %in% c("Institutionalized Democracy", "Institutionalized Autocracy")) %>%
  #pivot_longer(cols = c("1980", "2015"), names_to = "Year", values_to = "Score") %>%
